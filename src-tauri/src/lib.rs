...
use commands::{activation, ai as ai_cmd, analytics, conversations as conv_cmd, depth, gaps, mastery, progress, review, schedule, sync_server as sync_cmd, voice as voice_cmd};
